...
void placerValeursPossible(tGrille grille)
{
    for (int ligne=0; ligne<TAILLE; ligne++)
    {
        ...
        {
            grille[ligne][colonne].nbCandidats=0; // Réinitialise le nombre de valeurs possibles
            ...
            { // Parcours de toutes les valeurs possibles
                ...
                {
                    grille[ligne][colonne].candidats[valeur]=true;
    ...
    for (int ligne=0; ligne<TAILLE; ligne++)
    {
        for (int colonne=0; colonne<TAILLE; colonne++)
        {
            if ((grille[ligne][colonne].nbCandidats)==1)
            {
                for (int valeur=1; valeur<=TAILLE; valeur++)
                {
                    if (grille[ligne][colonne].candidats[valeur])
                    {
...
/**
    ...
    * @param grille[TAILLE][TAILLE] Grille du sudoku de taille TAILLE.
    * 
    * @returns False si la grille n'est pas pleine True sinon.
*/
bool grillePleine(tGrille grille)
{
    ...
    for (int ligne = 0; ligne < TAILLE; ligne++)
    {
        for (int colonne = 0; colonne < TAILLE; colonne++)
        {
            if (grille[ligne][colonne].valeur == 0) /* Si il y a une case vide */
            {
                return false;
    }}}
